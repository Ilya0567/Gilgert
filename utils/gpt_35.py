...
FUNCTIONS = [
    {
        ...
        "description": "Показать меню с подборкой здоровых рецептов пользователю. Вызывай эту функцию, когда пользователь интересуется рецептами, здоровым питанием, ищет блюда для конкретного приема пищи (завтрак, обед и т.д.), спрашивает о том, что можно приготовить, или просит предложить блюда.",
        "parameters": {
            "type": "object",
            "properties": {},
            "required": []
